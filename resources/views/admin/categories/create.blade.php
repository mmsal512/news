            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
                <form method="POST" action="{{ route('admin.categories.store') }}">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <!-- Slug -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Slug') }} <span class="text-gray-500 text-xs">({{ __('Auto-generated if empty') }})</span></label>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Color') }} <span class="text-gray-500 text-xs">(Hex)</span></label>
                                <input type="color" name="color" value="{{ old('color', '#6B7280') }}"
                                    class="mt-1 block w-full h-10 rounded-md border-gray-300 shadow-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Icon') }} <span class="text-gray-500 text-xs">(Font Awesome class)</span></label>
